export const PrepopData: any = [`
		DROP TABLE IF EXISTS SessionLines;
	`, `
	...
	`, `
		CREATE TABLE IF NOT EXISTS "SessionLines" (
		'sessionId'	INTEGER,
		'answerId'	INTEGER,
		'questionId'	INTEGER,
	...
	`,
	[`INSERT INTO 'Questions' VALUES (1,'How much sugar is in this','Energy Drink','energyDrink.png','500mL',1);`],
	[`INSERT INTO 'Questions' VALUES (2,'How much sugar is in this','Can of Orange Pop','OrangePopSized.png','355mL',8);`],
	[`INSERT INTO 'Questions' VALUES (3,'How much sugar is in this','Small Chocolate Milk','ChocolateMilkSized.png','237mL',9);`],
	[`INSERT INTO 'Questions' VALUES (4,'How much sugar is in this','Can of Iced tea','IcedTeaSized.png','355mL',13);`],
	[`INSERT INTO 'Questions' VALUES (5,'How much sugar is in this','Sports Drink','sportsdrink.png','700mL',19);`],
	[`INSERT INTO 'Questions' VALUES (6,'How much sugar is in this','Cola','Coke.png','591mL',21);`],
	[`INSERT INTO 'Questions' VALUES (7,'How much sugar is in this','Slushy','slushie-sized.png','500mL',26);`],
	[`INSERT INTO 'Questions' VALUES (8,'How much sugar is in this','Box of orange juice','OrangeBoxSized.png','200mL',31);`],
	[`INSERT INTO 'Questions' VALUES (9,'How much sugar is in this','Small box of chocolate soy beverage','ChocolateSoyMilkSized.png','250mL',33);`],
	[`INSERT INTO 'Questions' VALUES (10,'How much sugar is in this','Ice Cappuccino','icedCapp.png','500mL',40);`],
	[`INSERT INTO 'Questions' VALUES (11,'How much sugar is in this','Small Hot Chocolate','hotchocolate.png','286mL',41);`],
	[`INSERT INTO 'Questions' VALUES (12,'How much sugar is in this','Fruit Punch','fruitPunch.png','355mL',45);`],
	[`INSERT INTO 'Questions' VALUES (13,'How much sugar is in this','Clear Pop','ClearPop.png','355mL',49);`],
	[`INSERT INTO 'Questions' VALUES (14,'How much sugar is in this','Milk Shake','milkshake.png','473mL',54);`],
	[`INSERT INTO 'Questions' VALUES (15,'How much sugar is in this','Vitamin Water','vitaminwater.png','591mL',60);`],
	[`INSERT INTO 'Questions' VALUES (16,'How much sugar is in this','Can of Lemonade','lemonade.png','355mL',61);`],
	[`INSERT INTO 'Questions' VALUES (17,'How much sugar is in this','Can of root beer','rootBeer.png','355mL',66);`],
	[`INSERT INTO 'Questions' VALUES (18,'How much sugar is in this','Small bottle of Cranberry Juice Drink/Cocktail','cranberryJuice.png','450mL',71);`],
	[`INSERT INTO 'Questions' VALUES (19,'How much sugar is in this','Kool aid jammer','koolaid.png','180mL',73);`],
	[`INSERT INTO 'Questions' VALUES (20,'How much sugar is in this','Bottle of water','waterbottle.png','any',80);`],`
